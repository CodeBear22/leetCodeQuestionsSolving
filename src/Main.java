import com.kunal.leetcode.ProductOfArrayExceptSelf;
import com.kunal.leetcode.TopKFrequentElements;
...
//        test(20, 16, 2);
    ...
    public static void problem_347() {
        problemStartEndAnnouncer(347, true);
        ...
        int k = 2;
        System.out.println(Arrays.toString(app.topKFrequent(input, k)));

        problemStartEndAnnouncer(347, false);
    }

    public static void problem_238() {
        problemStartEndAnnouncer(238, true);

        ProductOfArrayExceptSelf app = new ProductOfArrayExceptSelf();
        int[] input = {1, 2, 3, 4};

        int[] result = app.productExceptSelf(input);

        System.out.println(Arrays.toString(result));

        problemStartEndAnnouncer(238, false);
    }
...
//
//        String inputString = "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaab";
//
//
//        List<String> input = Arrays.asList(list);
//
//        System.out.println(app.wordBreak(inputString, input));
//
//        problemStartEndAnnouncer(139, false);
//    }
//
//    public static void problem_131() {
//        problemStartEndAnnouncer(131, true);
//
//        String input = "aab";
//
//        PalindromePartitioning app = new PalindromePartitioning();
//
//        List<List<String>> result = app.partition(input);
//
...
//        }
//
//        problemStartEndAnnouncer(131, false);
//    }
//
//    public static void problem_146() {
//        problemStartEndAnnouncer(146, true);
//        LRUCache cache = null;
//
...
//        int[][] commandsValue = {{2}, {2}, {2, 6}, {1}, {1, 5}, {1, 2}, {1}, {2}};
//
//        for (int i = 0; i < commands.length; i++) {
//            switch (commands[i]) {
//                case "LRUCache": {
//                    System.out.println("LRU created with capacity : " + commandsValue[0][0]);
//                    cache = new LRUCache(commandsValue[0][0]);
//                }
//                break;
//
//                case "put": {
//                    System.out.println("PUT operation -> key : " + commandsValue[i][0] + " value : " + commandsValue[i][1]);
//                    System.out.println("LRU before operation");
//                    cache.printCache();
//                    cache.put(commandsValue[i][0], commandsValue[i][1]);
//                    System.out.println("LRU after operation");
//                    cache.printCache();
//                }
//                break;
//
//                case "get": {
//                    System.out.println("GET operation -> key : " + commandsValue[i][0]);
//                    System.out.println("LRU before operation");
//                    System.out.println("Result : " + cache.get(commandsValue[i][0]));
//                    System.out.println("LRU after operation");
//                    cache.printCache();
//                }
//                break;
//            }
//        }
//        problemStartEndAnnouncer(146, false);
//
//    }
//
//    public static void problem_230() {
//        problemStartEndAnnouncer(230, true);
//
//        KthSmallestElementInBST app = new KthSmallestElementInBST();
//
//        Integer[] nodeValues = {5, 3, 122, 2, 4, null, null, 1};//{3, 1, 5, 0, 2, 4, 6};
//        TreeNode root = Helper.constructTree(nodeValues);
//        System.out.println(app.kthSmallest(root, 6));
//
//        problemStartEndAnnouncer(230, false);
//    }
//
//    public static void problem_166() {
//        problemStartEndAnnouncer(166, true);
//
//        FractionToRecurringDecimal app = new FractionToRecurringDecimal();
//
//        System.out.println(app.fractionToDecimal(2, 3));
//
//        problemStartEndAnnouncer(166, false);
//
//    }
//
//    public static void problem_236() {
//        problemStartEndAnnouncer(236, true);
//
//        LowestCommonAncestorOfBinaryTree app = new LowestCommonAncestorOfBinaryTree();
//
//        Integer[] treeNodesValue = {3, 5, 1, 6, 2, 0, 8, null, null, 7, 4};
//        TreeNode input = Helper.constructTree(treeNodesValue);
//
//        TreeNode result = app.lowestCommonAncestor(input, input.right, input.left);
//
//        if (result != null)
...
//
//        String[] commands = {"insert", "search", "search", "startsWith", "insert", "search"};
...
//        }
//
//        problemStartEndAnnouncer(208, false);
//    }
//
//    public static void problem_227() {
//        problemStartEndAnnouncer(227, true);
//
//        BasicCalculatorII app = new BasicCalculatorII();
//
//        System.out.println(app.calculate("3+2*2"));
//
//        problemStartEndAnnouncer(227, false);
//    }
//
//    public static void problem_240() {
//        problemStartEndAnnouncer(240, true);
//
...
//        };
//
//        System.out.println(app.searchMatrix(input, 5));
//
//        problemStartEndAnnouncer(240, false);
//    }
//
//    public static void problem_74() {
//        problemStartEndAnnouncer(74, true);
//
//        Search2DMatrix app = new Search2DMatrix();
//
//        int[][] input = {
//                {1,   3,  5,  7},
//                {10, 11, 16, 20},
...
//        };
//
//        System.out.println(app.searchMatrix(input, 34));
//
//        problemStartEndAnnouncer(74, false);
//    }
//
//    public static void problem_200() {
//        problemStartEndAnnouncer(200, true);
//
...
//
//        System.out.println(app.numIslands(input));
//
//        problemStartEndAnnouncer(200, false);
//    }
//
//    public static void problem_26() {
//        problemStartEndAnnouncer(26, true);
//
//        RemoveDuplicatesFromSortedArray app = new RemoveDuplicatesFromSortedArray();
//
//        int[] input = {0,0};//,1,1,1,2,2,3,3,4};
//
//        int result = app.removeDuplicates(input);
//
//        System.out.println(result);
//
//        problemStartEndAnnouncer(26, false);
//    }
//
//    public static void problem_13() {
//        problemStartEndAnnouncer(13, true);
//
//        RomanToInteger app = new RomanToInteger();
//        System.out.println(app.romanToInt("LVIII"));
//
//        problemStartEndAnnouncer(13, false);
//    }
//
//    public static void problem_12() {
//        problemStartEndAnnouncer(12, true);
//
//        IntegerToRoman app = new IntegerToRoman();
//
//        System.out.println(app.intToRoman(1993));
//
//        problemStartEndAnnouncer(12, false);
//    }
//
//    public static void problem_395() {
//        problemStartEndAnnouncer(395, true);
//
//        LongestSubstringWithAtLeastKRepeatingCharacters app = new LongestSubstringWithAtLeastKRepeatingCharacters();
//
//        System.out.println(app.longestSubstring("ababacb", 3));
//
//        problemStartEndAnnouncer(395, false);
//    }
//
//    public static void problem_328() {
//        problemStartEndAnnouncer(328, true);
//
//        OddEvenLinkedList app = new OddEvenLinkedList();
//
//        int[] nodeValues = {1,2,3,4,5};
//
//        ListNode input = Helper.makeArrayToLinkedList(nodeValues);
//        Helper.printList(input);
//
//        ListNode result = app.oddEvenList(input);
//
//        Helper.printList(result);
//
//        problemStartEndAnnouncer(328, false);
//    }
//
//    public static void problem_152() {
//        problemStartEndAnnouncer(152, true);
//
//        MaximumProductSubarray app = new MaximumProductSubarray();
//        int[] input = {2,3,-2,4};
//        System.out.println(app.maxProduct(input));
//
//        problemStartEndAnnouncer(152, true);
//    }
}
